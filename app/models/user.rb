class User < ApplicationRecord
  ...
  validates :birthdate_year,          presence: true, on: :validates1
  validates :birthdate_month,         presence: true, on: :validates1
  validates :birthdate_day,           presence: true, on: :validates1
